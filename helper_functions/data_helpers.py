...
def parameter(start_day, start_month, end_day, end_month, variable_id):
    parameters = {
        "variableId" : variable_id,
        #"x-api-key" : fingrid_key,
        "start_time" : f"2022-{start_month :02d}-{start_day :02d}T00:00:00Z",
        "start_time" : f"2022-{end_month :02d}-{end_day :02d}T23:59:00Z"
    }
